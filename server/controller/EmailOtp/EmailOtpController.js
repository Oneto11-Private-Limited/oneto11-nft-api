    ...
    try {
        return new Promise(function(Resolve, Reject) {
            let transporter = nodemailer.createTransport({
                ...
                // auth: {	
                //     user: 'marketplace@oneto11.in', // generated ethereal user
                //     pass: 'Mnk!209jkotp' // generated ethereal password	
                // },	
                // tls: {	
                ...
                await otpModel.findOne({ email: Email }).then(async(otpData) => {
                    if (otpData) {
                        ...
                        if (stamp + 120 < currentStamp) {
                            ...
                            let date = new Date();
                            let htmlContent = "<p>Hi "+emailName[0]+",</p><p>Verify your email to finish signing up with OneTo11. Use the following verification code.</p>";
                            htmlContent = htmlContent + "<h1>" + otp + "</h1><p>The verification code is valid for 30 minutes.</p><p>Team OneTo11</p>";
