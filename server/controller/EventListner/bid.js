  ...
  if (typeof nftData == "object" && typeof lastBidderData == "object") {
    if (
      ...
      let htmlContent =
        ...
        Number(amount) / 10 ** 18 +
        " <img src='https://rest-api-oneto11-dev.herokuapp.com/currency/curr_logo.png' style='width:18px;height:18px; position:relative;top:-2px; margin-right:2px;' alt = ''/></p>";
      htmlContent =
        htmlContent +
        "<p>Winner name is: <b>" +
        ...
        "' target='_blank'>wallet address</a></b></p><p>Team OneTo11</p>";
  ...
  if (
    ...
    if (
      ...
      let htmlContent =
        ...
        Number(amount) / 10 ** 18 +
        "</b> <img src='https://rest-api-oneto11-dev.herokuapp.com/currency/curr_logo.png' style='width:18px;height:18px; position:relative;top:-2px; margin-right:2px;' alt = ''/>. ";
      htmlContent =
        htmlContent + "<p>Bidder name is <b>" + bidderData.displayName + "<b></p><p>Team OneTo11</p>";
      var subject = "New Bid";
